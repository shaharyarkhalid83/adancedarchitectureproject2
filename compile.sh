...
gcc -fopenmp -O2 -DPAPI -std=c11 -c  ./src/nbody_cpu_multicore.c
...
icc -fopenmp -DOMP -DPAPI -no-vec -qopt-report -O2 -std=c11 -o nbody_cpu_icc_serial.o -c  ./src/nbody_cpu_serial.c
